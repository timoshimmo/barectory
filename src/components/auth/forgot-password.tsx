  ...
  return (
    <StateMachineProvider>
      <div className="flex h-full min-h-screen w-screen flex-col justify-center bg-light py-6 px-5 sm:p-8 md:h-auto md:min-h-0 md:max-w-[480px] md:rounded-xl">
        ...
        */}
        <RenderFormSteps />
        <div className="relative flex flex-col items-center justify-center text-sm mt-2 mb-4 text-heading sm:mt-5 sm:mb-5">
          <hr className="w-full" />
          <span className="start-2/4 -ms-4 absolute -top-1.5 bg-light px-2">
            {t('text-or')}
          </span>
        </div>
